...
class ViewAntiViral extends StatefulWidget {
  const ViewAntiViral({super.key});

  @override
  State<ViewAntiViral> createState() => _ViewAntiViralState();
}

class _ViewAntiViralState extends State<ViewAntiViral> {
  String _searchQuery = '';

  @override
  Widget build(BuildContext context) {
    final Stream<QuerySnapshot> antibioticsStream = FirebaseFirestore.instance
        .collection('antiviral')
        .orderBy('createdAt', descending: true)
        .snapshots();

    return Scaffold(
      appBar: AppBar(
        title: const Text('Anti viral Medicines'),
            ...
            child: StreamBuilder<QuerySnapshot>(
              ...
              builder: (context, snapshot) {
                ...
                if (!snapshot.hasData || snapshot.data!.docs.isEmpty) {
                  return const Center(child: Text('No Anti viral found.'));
                }
