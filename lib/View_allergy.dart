...
class ViewAllergyPage extends StatefulWidget {
  const ViewAllergyPage({super.key});

  @override
  State<ViewAllergyPage> createState() => _ViewAllergyPageState();
}

class _ViewAllergyPageState extends State<ViewAllergyPage> {
  String _searchQuery = '';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('Allergy Medicines'),
            ...
            child: StreamBuilder<QuerySnapshot>(
              ...
              builder: (context, snapshot) {
                ...
                if (!snapshot.hasData || snapshot.data!.docs.isEmpty) {
                  return const Center(child: Text('No Pain relief found.'));
                }
