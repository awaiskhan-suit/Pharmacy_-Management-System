...
class _AddAllergyPageState extends State<AddAllergyPage> {
  ...
  Future<void> _addAntibiotic() async {
    if (_formKey.currentState!.validate()) {
      await _firestore.collection('allergy').add({
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text('allergy medicine added successfully')),
      );
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Add allergy Medicine'),
        ...
        child: Form(
          ...
          child: ListView(
            children: [
              ...
              ElevatedButton.icon(
                onPressed: (){
                  Navigator.push(context, MaterialPageRoute(builder: (context)=>ViewAllergyPage()));
                },
