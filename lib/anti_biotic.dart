...
import 'package:pharmacy_invoice/view_antibiotic.dart';

class AddAntibioticPage extends StatefulWidget {
  const AddAntibioticPage({super.key});

  @override
  State<AddAntibioticPage> createState() => _AddAntibioticPageState();
}

class _AddAntibioticPageState extends State<AddAntibioticPage> {
  ...
  Future<void> _addAntibiotic() async {
    if (_formKey.currentState!.validate()) {
      await _firestore.collection('antibiotics').add({
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text('Antibiotic added successfully')),
      );
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Add Antibiotic Medicine'),
            ...
            children: [
              ...
              TextFormField(
                ...
                decoration: const InputDecoration(
                  labelText: 'Medicine Name (e.g., Ciproxin)',
              ...
              ElevatedButton.icon(
                onPressed: (){
                  Navigator.push(context, MaterialPageRoute(builder: (context)=>ViewAntibioticsPage()));
                },
