...
import 'package:pharmacy_invoice/view_antifungal.dart';

class AddAntifungalPage extends StatefulWidget {
  const AddAntifungalPage({super.key});

  @override
  State<AddAntifungalPage> createState() => _AddAntifungalPageState();
}

class _AddAntifungalPageState extends State<AddAntifungalPage> {
  ...
  Future<void> _addAntibiotic() async {
    if (_formKey.currentState!.validate()) {
      await _firestore.collection('anti_fungal').add({
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text('Anti Fungal medicine added successfully')),
      );
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Add Anti Fungal Medicine'),
          ...
          child: ListView(
            children: [
              ...
              ElevatedButton.icon(
                ...
                label: const Text('Add Anti Fungal'),
              ...
              ElevatedButton.icon(
                onPressed: (){
                  Navigator.push(context, MaterialPageRoute(builder: (context)=>ViewAntiFungalPage()));
                },
