...
import 'ViewColdFlu.dart';
import 'View_allergy.dart';

class AddcoldfluePage extends StatefulWidget {
  const AddcoldfluePage({super.key});

  @override
  State<AddcoldfluePage> createState() => _AddcoldfluePageState();
}

class _AddcoldfluePageState extends State<AddcoldfluePage> {
  ...
  Future<void> _addAntibiotic() async {
    if (_formKey.currentState!.validate()) {
      await _firestore.collection('coldflue').add({
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text('Cold and Flu medicine added successfully')),
      );
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Add Cold and flu Medicine'),
          ...
          child: ListView(
            children: [
              ...
              ElevatedButton.icon(
                ...
                label: const Text('Add Cold and Flue'),
              ...
              ElevatedButton.icon(
                onPressed: (){
                  Navigator.push(context, MaterialPageRoute(builder: (context)=>ViewColdFluePage()));
                },
