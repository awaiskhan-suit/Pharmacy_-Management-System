...
import 'package:pharmacy_invoice/view_painrelief.dart';

class AddPainReliefPage extends StatefulWidget {
  const AddPainReliefPage({super.key});

  @override
  State<AddPainReliefPage> createState() => _AddPainReliefPageState();
}

class _AddPainReliefPageState extends State<AddPainReliefPage> {
  ...
  Future<void> _addAntibiotic() async {
    if (_formKey.currentState!.validate()) {
      await _firestore.collection('painrelief').add({
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text('Pain Relief medicine added successfully')),
      );
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Add Pain_Relief Medicine'),
          ...
          child: ListView(
            children: [
              ...
              ElevatedButton.icon(
                ...
                label: const Text('Add Pain Relief'),
              ...
              ElevatedButton.icon(
                onPressed: (){
                  Navigator.push(context, MaterialPageRoute(builder: (context)=>Viewpainreliefpage()));
                },
