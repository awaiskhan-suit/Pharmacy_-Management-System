...
import 'package:pharmacy_invoice/view_skincare.dart';


class AddSkinPage extends StatefulWidget {
  const AddSkinPage({super.key});

  @override
  State<AddSkinPage> createState() => _AddSkinPageState();
}

class _AddSkinPageState extends State<AddSkinPage> {
  ...
  Future<void> _addAntibiotic() async {
    if (_formKey.currentState!.validate()) {
      await _firestore.collection('skincare').add({
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text('Skin care medicine added successfully')),
      );
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Add skincare Medicine'),
          ...
          child: ListView(
            children: [
              ...
              ElevatedButton.icon(
                ...
                label: const Text('Add Skin Care'),
              ...
              ElevatedButton.icon(
                onPressed: (){
                  Navigator.push(context, MaterialPageRoute(builder: (context)=>ViewSkinCarePage()));
                },
