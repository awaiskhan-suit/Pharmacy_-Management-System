...
class ViewAntibioticsPage extends StatefulWidget {
  const ViewAntibioticsPage({super.key});

  @override
  State<ViewAntibioticsPage> createState() => _ViewAntibioticsPageState();
}

class _ViewAntibioticsPageState extends State<ViewAntibioticsPage> {
  String _searchQuery = '';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('Antibiotic Medicines'),
