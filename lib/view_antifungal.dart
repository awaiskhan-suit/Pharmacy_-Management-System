...
class ViewAntiFungalPage extends StatefulWidget {
  const ViewAntiFungalPage({super.key});

  @override
  State<ViewAntiFungalPage> createState() => _ViewAntiFungalPageState();
}

class _ViewAntiFungalPageState extends State<ViewAntiFungalPage> {
  String _searchQuery = '';

  @override
  Widget build(BuildContext context) {
    final Stream<QuerySnapshot> antibioticsStream = FirebaseFirestore.instance
        .collection('anti_fungal')
        .orderBy('createdAt', descending: true)
        .snapshots();

    return Scaffold(
      appBar: AppBar(
        title: const Text('Anti Fungal Medicines'),
            ...
            child: StreamBuilder<QuerySnapshot>(
              ...
              builder: (context, snapshot) {
                ...
                if (!snapshot.hasData || snapshot.data!.docs.isEmpty) {
                  return const Center(child: Text('No Anti Fungal found.'));
                }
