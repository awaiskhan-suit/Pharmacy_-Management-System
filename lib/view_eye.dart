...
class ViewEyePage extends StatefulWidget {
  const ViewEyePage({super.key});

  @override
  State<ViewEyePage> createState() => _ViewEyePageState();
}

class _ViewEyePageState extends State<ViewEyePage> {
  String _searchQuery = '';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('Eye Medicines'),
